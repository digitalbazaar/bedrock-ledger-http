...
function addRoutes(app) {
  ...
  docs.annotate.post(basePath, {
    ...
    securedBy: ['null'],
    responses: {
      201: 'Ledger creation was successful. HTTP Location header contains ' +
        'URL of newly created ledger.',
  ...
  docs.annotate.post(basePath + '/:ledger', {
    description: 'Append a new event to a ledger',
    schema: 'services.ledger.postLedgerEvent',
    securedBy: ['null'],
    responses: {
      201: 'Ledger was appended successfully. HTTP Location header contains ' +
        'URL of newly appended event.',
